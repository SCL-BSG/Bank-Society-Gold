...
unsigned int LimitOrphanTxSize(unsigned int nMaxOrphans)
{
    ...
    while (mapOrphanTransactions.size() > nMaxOrphans)
    {
        ...
        //LogPrintf("*** RGP LimitOrphanTxSize \n");
...
CBlockIndex* FindBlockByHeight(int nHeight)
{
    ...
    //LogPrintf("*** RGP  FindBlockByHeight\n");
...
/* RGP Optimised for large orphan trees */
...
uint256 WantedByOrphan(const COrphanBlock* pblockOrphan)
{
    ...
    while (mapOrphanBlocks.count(pblockOrphan->hashPrev)){
        ...
        //LogPrintf("*** RGP WantedByOrphan loop \n");
...
void static PruneOrphanBlocks()
{
    ...
    //LogPrintf("*** RGP PruneOrphanBlocks \n");
...
LogPrintf("ProcessBlock: ORPHAN BLOCK %lu, prev=%s\n", (unsigned long)mapOrphanBlocks.size(), pblock->hashPrevBlock.ToString());
        ...
        /* --------------------------------------------------------------------
         ...
         nMaxConnections = 3;       /* this affects net.cpp processing of incoming connections */
...
bool LoadBlockIndex(bool fAllowNew)
{
   ...
   // LogPrintf("*** RGP LoadBlockIndex Start\n");
    ...
    //LogPrintf("*** RGP LoadBlockIndex End\n");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv)
{
    ...
    //LogPrintf("*** RGP ProcessMessage Start\n");
...
//LogPrintf("*** RGP ProcessMessage End \n");
...
bool ProcessMessages(CNode* pfrom)
{
    ...
    while (!pfrom->fDisconnect && it != pfrom->vRecvMsg.end()) {
      ...
      //  LogPrintf("*** RGP ProcessMessages loop 1\n");
        ...
        try
        {
            ...
            //LogPrintf("*** RGP calling ProcessMessage \n");
    ...
    //LogPrintf("*** RGP ProcessMessages End \n");
...
bool SendMessages(CNode* pto, bool fSendTrickle)
{
    ...
    if (lockMain) {
        ...
        while (!pto->mapAskFor.empty() && (*pto->mapAskFor.begin()).first <= nNow)
        {
            ...
            //LogPrintf("*** RGP SendMessages loop1 \n");
